...
|  GET   | [/classes/{name}/used-categories](code/classes/name/used-categories/get.md)       | Retrive categories used throughout the hierarchy of a given class                                                                                                                                                       |                                                                               -                                                                                | -       |
|  GET   | [/classes/{name}/methods](code/classes/name/methods/get.md)                       | Retrive methods of a given class                                                                                                                                                                                        |                                                                               -                                                                                | -       |
|  GET   | [/usual-categories](code/usual-categories/get.md)                                 | Retrive popular categories used throughout the system                                                                                                                                                                   |                                                                               -                                                                                | -       |
|  GET   | [/packages](code/packages/get.md)                                                 | Retrive all packages                                                                                                                                                                                                    |                                                                            `names`                                                                             | -       |
|  GET   | [/packages/{name}](code/packages/name/get.md)                                     | Retrive a given package                                                                                                                                                                                                 |                                                                               -                                                                                | -       |
|  GET   | [/search](code/search/get.md)                                                     | Perform a search on the system                                                                                                                                                                                          |                                                                               -                                                                                | -       |
|  GET   | [/autocompletions](code/autocompletions/post.md)                                  | Retrive completion entries for a given code, position and context                                                                                                                                                       |                                                                               -                                                                                | -       |
