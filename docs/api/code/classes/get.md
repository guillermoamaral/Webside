...
Retrieve all subclasses of a given root superclass (the uppermost class in the system if no root is provided).
It is also possible get a tree structure by using `tree=true` option as well as to limit the depth in class hierarchy by using `depth=[n]` option.    
...
**Example 1: Number subclasses** : `GET /classes?root=Number`.
...
[
    ...
    {
        "class": "ScaledDecimal class",
        "indexable": false,
        "size": 0,
        "printString": "ScaledDecimal",
        "name": "ScaledDecimal",
    ...
    {
        "class": "LargeInteger class",
        "indexable": false,
        "size": 0,
        "printString": "LargeInteger",
        "name": "LargeInteger",
    ...
    {
        "class": "LargeNegativeInteger class",
        "indexable": false,
        "size": 0,
        "printString": "LargeNegativeInteger",
    ...
    {
        "class": "LargePositiveInteger class",
        "indexable": false,
        "size": 0,
        "printString": "LargePositiveInteger",
