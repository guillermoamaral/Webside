...
This endpoint contains a _variable_ part, `/*`, in the URI that indicates the path from the root (pinned) object to the slot of interest by naming each slot in between.
