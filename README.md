...
* Not only this IDE could be used to work upon different Smalltalk images as its back-end but also it could allow several developers to work on the same Smalltalk instance (image) simulataneously, making Webside a collaborative environment naturally.
